...
import { UserPlus, Mail, Lock, User, ShieldCheck, Zap, BarChart3 } from 'lucide-react';
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            >
              ...
              <p className="mt-3 text-base text-blue-100/70 max-w-sm mx-auto leading-relaxed">
                Create your account to apply for instant personal loans with transparent terms and quick digital approvals.
              </p>
            </motion.div>
          </div>
